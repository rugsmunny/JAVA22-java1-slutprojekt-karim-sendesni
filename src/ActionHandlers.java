...
//Class for handling actions - for now it handels:
//Klick-actions: addEventButton (class Calender), deleteEventButton (class Calender)
//Focus-actions: eventInputTextfield (class Calender)
public class ActionHandlers {
    String textFieldForNewCalendarNoteInput;
        ...
        addEventButton.addActionListener(e -> {
            ...
            for (Component weekDayPanelComponent : weekDayPanel.getComponents()) {
                ...
                if (weekDayPanelComponent instanceof JTextField &&
                    ...
                    ((JTextField) weekDayPanelComponent).setText(textFieldForNewCalendarNoteInput);

                    textFieldForNewCalendarNoteInput = "";
    ...
    void inputTextFieldFocusAction(JTextField inputTextField) {
        ...
        inputTextField.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                        ...
                        textFieldForNewCalendarNoteInput = inputTextField.getText();
