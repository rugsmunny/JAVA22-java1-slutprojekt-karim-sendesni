...
public class Calender extends JFrame {
    ...
    WeekDayNameAndDatePanel weekDayNameAndDatePanel;
    JButton addEventButton, deleteEventButton;
    ActionHandlers action = new ActionHandlers();
    ...
    void createCalenderLayout() {
        ...
        for (int iterations = 1; iterations < 8; iterations++) {
            ...
            weekDayNameAndDatePanel = new WeekDayNameAndDatePanel();

            weekDayPanel.setBackground(WHITE);

            weekDayPanel.setLayout(new GridLayout(12, 1));

            weekDayPanel.add(weekDayNameAndDatePanel.addWeekDayNameToPanelTop(iterations));

            weekDayPanel.add(weekDayNameAndDatePanel.addWeekDayDateToPanelTop(iterations));
